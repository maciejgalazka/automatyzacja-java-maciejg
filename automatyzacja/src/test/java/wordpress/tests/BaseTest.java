...
public class BaseTest {
    ...
    public void initWebDriver () throws IOException {
        ...
        // moze byc tez Capabilities capabilities = new ChromeOptions();
        // URL url = new URL("http://localhost:6543/wd/hub"); //selenium hub rest api
        // driver = new RemoteWebDriver(url, chromeOptions);

        Properties testProperties = new Properties();
        InputStream testPropertiesInputStream = wordpress.tests.BaseTest.class.getClassLoader().getResourceAsStream("test.properties");
